...
#### サーボモータ２の円形サーボホーンの角度調整

サーボモータ２（緑色のシールが貼られた方）に取り付けられた円形サーボホーンの角度を調整します。お互いの切り欠きが画像のように90°になるように指で回転させてください。

この操作は、サーボモータ１では必要ありません。

<img src="images/assembly/disk_horn_rotation.jpg" width="60%">
